...
namespace dtSearch { namespace Engine {
	...
	public ref class SearchResultsItem {
		...
		/// </summary>
		/// <remarks>
		/// In the OnFound callback in ISearchStatusHandler, set ChangedItemScore = true and
		/// set Score to a new value to change the score of an item in search results.
		/// </remarks>
		bool ChangedItemScore;
