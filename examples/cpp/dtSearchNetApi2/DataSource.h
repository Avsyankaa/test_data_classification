...
namespace Engine
{
		...
		/// 
		/// DocName should preferably include the extension of the
		/// \original file, because the extension provides useful
		/// information about the original document format in some cases.
		/// 
